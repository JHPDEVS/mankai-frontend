        ...
        return(     
            <div className="flex">
                    {/* Sidebar */}   
                        ...
                        <div className='w-full flex mt-16 bg-gray-200 z-10' >
                            {/* main */}  
                            ...
                            {!isOpen &&
                                <div className={'w-0 h-screen bg-primarybg fixed top-16 right-0   lg:w-96'}>
                                        ...
                                        <Card className='m-1'>
                                            <div className='flex px-5 py-3 font-bold'>
                                                ...
                                                <div className='flex ml-4 my-auto justify-between w-full'>
                                                    <p className='text-lg text-gray-600'>장성규</p>
